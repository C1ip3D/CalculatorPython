            ...
            if startUnit == "miles" or startUnit == "mile" or startUnit == "mi":
                ...
                if endUnit == 'feet' or endUnit == 'foot' or endUnit == "ft":
                    ...
                    if answer == 'round' or answer == 'rounded':
                        print("The approximate measurement is now: ", round(startNum*5280))
                        again()
                    else:
                    ...
                    if answer == 'round' or answer == 'rounded':
                        print("The approximate measurement is now: ", round(startNum*1.60934))
                        again()
                    else:
                    ...
                    if answer == 'round' or answer == 'rounded':
                        print("The approximate measurement is now: ", round(startNum*1760))
                        again()
                    else:
                ...
                if endUnit == 'miles' or endUnit == 'mi' or endUnit == 'mile':
                    ...
                    if answer == 'round' or answer == 'rounded':
                        print("The approximate measurement is now: ", round(startNum*1.609344))
                        again()
                    else:
                    ...
                    if answer == 'round' or answer == 'rounded':
                        print("The approximate measurement is now: ", round(startNum*3280.84))
                        again()
                    else:
                    ...
                    if answer == 'round' or answer == 'rounded':
                        print("The approximate measurement is now: ", round(startNum*1093.61))
                        again()
                    else:
                ...
                if endUnit == 'miles' or endUnit == 'mi' or endUnit == 'mile':
                    ...
                    if answer == 'round' or answer == 'rounded':
                        print("The approximate measurement is now: ", round(startNum*3))
                        again()
                    else:
                    ...
                    if answer == 'round' or answer == 'rounded':
                        print("The approximate measurement is now: ", round(startNum*36))
                        again()
                    else:
                ...
                distance()
        def temp():
            startUnit = str(input("What is the starting unit Farenheit or Centigrade"))
            startNum = str(input("What is the starting number"))
            startNum = fractions.Fraction(startNum)
            if startUnit == "F" or startUnit == 'Farenheit':
                endNum = (5/9)*startNum - 32
                print("The temperature in centigrade is: ", endNum, "degrees")
            elif startUnit == "C" or startUnit == 'Centigrade' or startUnit == 'Celcius':
                endNum = (9/5)*startNum + 32
                print("The temperature in farenheit is: ", endNum, "degrees")
